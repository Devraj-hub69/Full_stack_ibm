...
async function displayFood(categories) {
    ...
    categories.forEach((el, index) => {
        ...
        heading.innerText = el.strCategory;

        let image = document.createElement("img");
        image.src = el.strCategoryThumb;
        image.alt = el.strCategory;
        ...
        div.append(heading, image, button);
